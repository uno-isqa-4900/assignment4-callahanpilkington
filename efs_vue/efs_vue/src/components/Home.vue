        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col col-12 col-sm-10 col-md-10">
                ...
                <div class="card">
                  ...
                  <img :src="require('@/assets/images/customer.jpg')" class="card-img-top" style="height: 15rem">
                ...
                <div class="card">
                  ...
                  <img :src="require('@/assets/images/nonstock.jpg')" class="card-img-top" style="height: 15rem">
                ...
                <div class="card">
                  ...
                  <img :src="require('@/assets/images/stocks.jpg')" class="card-img-top" style="height: 15rem">
